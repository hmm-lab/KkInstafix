...
SAMPLE_URLS = {
    ...
    "ifunny":      "https://ifunny.co/picture/test",
...
ABOUT_TEXT = (
    ...
    "Spotify, Twitch or other link and I will convert it for you automatically.\n\n"
...
async def handle_testall(msg, platform, custom_url=None):
    """Send one message per provider so the user can compare previews."""
    ...
    if not base_url:
        await msg.reply_text("No sample URL available. Pass one: /testall instagram https://...")
        return
...
async def on_startup(app):
    # Delete any existing webhook and drop stale updates before polling starts
