...
async def handle_caption(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    """Delegate to handlers module."""
    import handlers
    await handlers.handle_caption(update, context)

# ── Edit handler ──────────────────────────────────────────────────────────────
async def handle_edit(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    """Delegate to handlers module."""
    import handlers
    await handlers.handle_edit(update, context)
...
async def handle_inline_query(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    """Delegate to handlers module."""
    import handlers
    await handlers.handle_inline_query(update, context)
...
async def handle_new_members(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    """Delegate to handlers module."""
    import handlers
    await handlers.handle_welcome(update, context)
