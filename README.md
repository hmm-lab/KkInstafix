...
Current version: **1.13.0** — see [CHANGELOG.md](CHANGELOG.md) for release history.
...
- `test_handlers.py` — async handler tests with lightweight fakes (9 tests). Run the whole suite with `pytest`.
