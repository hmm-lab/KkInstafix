...
Current version: **1.53.0** — see [CHANGELOG.md](CHANGELOG.md) for release history.
...
- `/optout` — stop the bot from rewriting/reposting your own links in this chat (no admin needed). `/optin` resumes.
...
- `test_bot.py` — pure-function tests (133 tests). Run with `pytest test_bot.py`.
